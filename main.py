...
flags.DEFINE_string("data_dir", "/cache/data", "path to datasets [e.g. $HOME/data]")
flags.DEFINE_string("out_dir", "/cache/out", "Root directory for outputs [e.g. $HOME/out]")
...
def main(_):
  ...
  mox.file.copy_parallel(FLAGS.data_url, '/cache/data/celebA/')
